							...
							<List className={classes.list}>
								<ListItem disableGutters>
									...
									<Typography variant="body1" color="textPrimary">
										...
										Boétie 75008 Paris, France, and is the parent company to
										all subsidiaries of Material-UI Store.
									</Typography>
								</ListItem>
								<ListItem disableGutters>
									<ListItemAvatar>
								...
								<ListItem disableGutters>
									...
									<Typography variant="body1" color="textPrimary">
										“CONTENT” means source code, photos, images, vectors,
										moving images, animations, films, videos, audiovisual
										works, or other media together with all associated
